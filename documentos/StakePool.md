Um **stake pool** na **Cardano** é um **nó da rede** (node) que participa do processo de **validação de blocos** e **distribuição de recompensas** no protocolo de **proof-of-stake (PoS)** chamado **Ouroboros**.
